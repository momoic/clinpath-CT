...
#clinical$Acral_Lentiginous[clinical$HistologyDescription.x == grep("lentigo", histo_desc, ignore.case = TRUE, value = TRUE)] <- 1

clinical <- subset(clinical, Superficial_Spreading == 1 | Nodular == 1 | Desmoplastic == 1 | Lentigo_Maligna == 1)
```
...
```{r}
clinical <- clinical[,c("DxAge", "Ulceration", "Sex", "Height", "Weight", "BMI", "FaceHeadNeck", "UpperLimbShoulder", "LowerLimbHip", "Trunk", "Superficial_Spreading", "Nodular", "Desmoplastic", "Lentigo_Maligna", "Breslow_Depth", "Mitotic_Rate", 
"betablocker", "fibrate", "GLP1", "metformin", "SGLT2", "statin", "sulf", "TZD", "diabetes", "vitiligo", "node_met", "Mets", "Met_Time", "MSS", "MSS_Time")]
colnames(clinical) <- c("Age", "Ulceration", "Sex", "Height", "Weight", "BMI", "FaceHeadNeck", "UpperLimbShoulder", "LowerLimbHip", "Trunk", "Superficial_Spreading", "Nodular", "Desmoplastic", "Lentigo_Maligna", "Breslow_Depth", "Mitotic_Rate", 
"Betablocker", "Fibrate", "GLP1", "Metformin", "SGLT2", "Statin", "Sulfonylureas", "TZD", "Diabetes", "Vitiligo", "Node_Status", "Mets", "Met_Time", "MSS", "MSS_Time")
clinical = na.omit(clinical)


#write.csv(clinical, "C://PhD work//clinpath_CT//clinical_2023+2025.csv", row.names = FALSE)
```


```{r}
clinical <- clinical[,c("DxAge", "Ulceration", "Sex", "FaceHeadNeck", "UpperLimbShoulder", "LowerLimbHip", "Trunk", "Superficial_Spreading", "Nodular", "Desmoplastic", "Lentigo_Maligna", "Breslow_Depth", "Mitotic_Rate", "node_met", "Mets", "Met_Time", "MSS", "MSS_Time")]

colnames(clinical) <- c("Age", "Ulceration", "Sex", "FaceHeadNeck", "UpperLimbShoulder", "LowerLimbHip", "Trunk", "Superficial_Spreading", "Nodular", "Desmoplastic", "Lentigo_Maligna", "Breslow_Depth", "Mitotic_Rate", "Node_Status", "Mets", "Met_Time", "MSS", "MSS_Time")
clinical = na.omit(clinical)
